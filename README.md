...
## Set Dafult data by seeder
  - php artisan db:seed
  
## Generate auth key
 - php artisan key:generate
 - php artisan key:generate --show[pasete the code in env file APP_KEY = ]

## update any configarion if don't see the changes run bellow command
